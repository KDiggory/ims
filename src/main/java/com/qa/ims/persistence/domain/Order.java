...
public class Order {
	...
	//if only one type of item in order with id
	...
	//if two types of item in order
	public Order(Long id, String customerSurname, Long customerId, String itemName, Long itemId1, String itemName2,
			Long itemId2, Long numItems, Long totalCost) {
		super();
		this.id = id;
		this.customerSurname = customerSurname;
		this.customerId = customerId;
	...
	//if two types of item in order without id 
		public Order(String customerSurname, Long customerId, String itemName, Long itemId, String itemName2,
				Long itemId2, Long numItems, Long totalCost) {
			super();
			this.customerSurname = customerSurname;
			this.customerId = customerId;
	...
	//if three types of item in order
	public Order(Long id, String customerSurname, Long customerId, String itemName, Long itemId, String itemName2,
			Long itemId2, String itemName3, Long itemId3, Long numItems, Long totalCost) {
		super();
		this.id = id;
		this.customerSurname = customerSurname;
		this.customerId = customerId;
	...
	//if three types of item in order without id
		public Order(String customerSurname, Long customerId, String itemName, Long itemId, String itemName2,
				Long itemId2, String itemName3, Long itemId3, Long numItems, Long totalCost) {
			super();
			this.customerSurname = customerSurname;
